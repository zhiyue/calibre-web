...
class Image(GraphicsObject):
    ...
    def CMYKInvert(self, img):
        import PIL.Image
        import PIL.ImageOps

        return PIL.Image.merge(img.mode, [PIL.ImageOps.invert(b.convert('L')) for b in img.split()])
    ...
    def as_pil(self):
        ...
        elif filters == 'FlateDecode' or filters == 'LZWDecode' or filters == 'RunLengthDecode':
